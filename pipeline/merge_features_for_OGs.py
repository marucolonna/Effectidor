...
def get_ortho_dict(orthogroup_table):
    '''from the orthogroup_table, this function creates a dictionary that maps in every genome the loci to OGs'''
    genomes_orthogroup_dict = {}
    with open(orthogroup_table) as ortho_table:
...
def main():
    genomes_orthogroup_dict = get_ortho_dict(ortho_f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('working_directory', help='A path to the working directory.',
